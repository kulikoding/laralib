...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/landing_page/vendor/font-awesome/css/font-awesome.min.css') }}">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="{{ url('/') }}">Laralib</a>
        ...
        <div class="row h-100">
          <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
              ...
              <a href="{{ route('register') }}" class="btn btn-outline btn-xl">Start Now for Free!</a>
            </div>
          </div>
              ...
              <div class="device-mockup iphone6_plus portrait white">
                <div class="device">
                  <div class="screen">
                    ...
                    <img src="{{ asset('assets/landing_page/img/demo-screen-1.jpg') }}" class="img-fluid" alt="">
                  </div>
                  <div class="button">
